...
In particular, you will be using `/opt/machine-id/ssh_config` in your Ansible
...
You can create an inventory file `hosts` manually or use a script like the one below to
