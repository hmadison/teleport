...
Teleport supports exporting user SSH certificates with configurable key extensions. This allows the Teleport CA to be used in conjunction with GitHubs support for SSH Certificate Authorities. This way, users can access their organizations' repositories with short-lived, signed SSH certificates.
