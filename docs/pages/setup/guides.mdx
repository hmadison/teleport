...
<ul>
  ...
  <li>
    [Using Teleport's Certificate Authority with GitHub](./guides/ssh-key-extensions.mdx). Teleport SSH short lived certificates with Githubs Certificate Authority.
  </li>
</ul>
